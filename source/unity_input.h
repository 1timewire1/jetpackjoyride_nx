 ...
 * Float dispatch is wired to CallFloatMethod[V].
 */
...
/* Unity 6's two nativeInjectEvent class caches can arrive as untyped fake Java
 * classes.  The constructor resets the per-injection classifier; this hook then
 * answers its verified KeyEvent-first, MotionEvent-second instanceof sequence. */
